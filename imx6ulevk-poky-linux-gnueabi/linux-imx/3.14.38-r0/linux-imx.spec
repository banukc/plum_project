...
%description
Linux Kernel provided and supported by Freescale with focus on i.MX Family
Reference Boards. It includes support for many IPs such as GPU, VPU and
IPU.

%package -n kernel
Summary: Linux Kernel provided and supported by Freescale
Group: base
Requires: kernel-3.14.38-6ul-ga+ge4944a5
...
%package -n kernel-3.14.38-6ul-ga+ge4944a5
Summary: Linux Kernel provided and supported by Freescale
Group: base
Requires: kernel-image-3.14.38-6ul-ga+ge4944a5
Requires(post): kernel-image-3.14.38-6ul-ga+ge4944a5
Provides: kernel-3.14.38-6UL_ga+ge4944a5
Provides: kernel-base

%description -n kernel-3.14.38-6ul-ga+ge4944a5
Linux Kernel provided and supported by Freescale with focus on i.MX Family
Reference Boards. It includes support for many IPs such as GPU, VPU and
IPU.
...
Summary: Linux Kernel provided and supported by Freescale
Group: base
Provides: elf(buildid) = f8affa1e6dbdcbfa7be40fe1649d72c10b0959d3
...
%package -n kernel-image-3.14.38-6ul-ga+ge4944a5
Summary: Linux Kernel provided and supported by Freescale
Group: base
Provides: kernel-image

%description -n kernel-image-3.14.38-6ul-ga+ge4944a5
Linux Kernel provided and supported by Freescale with focus on i.MX Family
Reference Boards. It includes support for many IPs such as GPU, VPU and
IPU.
...
Suggests: kernel-module-ath6kl-core-dev
...
Suggests: kernel-3.14.38-6UL_ga+ge4944a5-dev
Suggests: kernel-module-zaurus-dev
Suggests: kernel-module-mxc-mlb-dev
...
Suggests: kernel-module-ath6kl-sdio-dev
...
Requires: kernel-module-mxc-mlb
...
Requires: kernel-module-ath6kl-sdio
...
Requires: kernel-module-ath6kl-core
...
Group: base
Requires: kernel-3.14.38-6UL_ga+ge4944a5
Requires(post): kernel-3.14.38-6UL_ga+ge4944a5
Requires(postun): kernel-3.14.38-6UL_ga+ge4944a5
...
%package -n kernel-module-mxc-mlb
Summary: mxc-mlb kernel module
Group: base
Requires: kernel-3.14.38-6UL_ga+ge4944a5
Requires(post): kernel-3.14.38-6UL_ga+ge4944a5
Requires(postun): kernel-3.14.38-6UL_ga+ge4944a5

%description -n kernel-module-mxc-mlb
mxc-mlb kernel module; MLB150 low level driver
...
%package -n kernel-module-ath6kl-core
Summary: ath6kl-core kernel module
Group: base
Requires: kernel-3.14.38-6UL_ga+ge4944a5
Requires(post): kernel-3.14.38-6UL_ga+ge4944a5
Requires(postun): kernel-3.14.38-6UL_ga+ge4944a5

%description -n kernel-module-ath6kl-core
ath6kl-core kernel module; Core module for AR600x SDIO and USB devices.

%package -n kernel-module-ath6kl-sdio
Summary: ath6kl-sdio kernel module
Group: base
Requires: kernel-3.14.38-6UL_ga+ge4944a5
Requires: kernel-module-ath6kl-core
Requires(post): kernel-3.14.38-6UL_ga+ge4944a5
Requires(post): kernel-module-ath6kl-core
Requires(postun): kernel-3.14.38-6UL_ga+ge4944a5
Requires(postun): kernel-module-ath6kl-core

%description -n kernel-module-ath6kl-sdio
ath6kl-sdio kernel module; Driver support for Atheros AR600x SDIO devices
...
%post -n kernel-3.14.38-6ul-ga+ge4944a5
# kernel-3.14.38-6ul-ga+ge4944a5 - postinst
	if [ ! -e "$D/lib/modules/3.14.38-6UL_ga+ge4944a5" ]; then
...
%post -n kernel-image-3.14.38-6ul-ga+ge4944a5
# kernel-image-3.14.38-6ul-ga+ge4944a5 - postinst
	update-alternatives --install /boot/zImage zImage /boot/zImage-3.14.38-6UL_ga+ge4944a5 31438 || true


%postun -n kernel-image-3.14.38-6ul-ga+ge4944a5
# kernel-image-3.14.38-6ul-ga+ge4944a5 - postrm
if [ "$1" = "0" ] ; then
update-alternatives --remove zImage zImage-3.14.38-6UL_ga+ge4944a5 || true
fi
...
%post -n kernel-module-mxc-mlb
# kernel-module-mxc-mlb - postinst
#!/bin/sh
if [ -z "$D" ]; then
	depmod -a 3.14.38-6UL_ga+ge4944a5
else
...
%postun -n kernel-module-mxc-mlb
# kernel-module-mxc-mlb - postrm
#!/bin/sh
if [ "$1" = "0" ] ; then
if [ -z "$D" ]; then
	depmod -a 3.14.38-6UL_ga+ge4944a5
...
%post -n kernel-module-ath6kl-core
# kernel-module-ath6kl-core - postinst
#!/bin/sh
if [ -z "$D" ]; then
	depmod -a 3.14.38-6UL_ga+ge4944a5
else
...
%postun -n kernel-module-ath6kl-core
# kernel-module-ath6kl-core - postrm
#!/bin/sh
if [ "$1" = "0" ] ; then
if [ -z "$D" ]; then
	depmod -a 3.14.38-6UL_ga+ge4944a5
...
%post -n kernel-module-ath6kl-sdio
# kernel-module-ath6kl-sdio - postinst
#!/bin/sh
if [ -z "$D" ]; then
	depmod -a 3.14.38-6UL_ga+ge4944a5
else
...
%postun -n kernel-module-ath6kl-sdio
# kernel-module-ath6kl-sdio - postrm
#!/bin/sh
if [ "$1" = "0" ] ; then
if [ -z "$D" ]; then
	depmod -a 3.14.38-6UL_ga+ge4944a5
...
%files -n kernel-3.14.38-6ul-ga+ge4944a5
%defattr(-,-,-,-)
%dir "/lib"
%dir "/lib/modules"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/modules.builtin"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/modules.order"

%files -n kernel-vmlinux
%defattr(-,-,-,-)
%dir "/boot"
"/boot/vmlinux-3.14.38-6UL_ga+ge4944a5"

%files -n kernel-image-3.14.38-6ul-ga+ge4944a5
%defattr(-,-,-,-)
%dir "/boot"
"/boot/zImage-3.14.38-6UL_ga+ge4944a5"

%files -n kernel-dev
%defattr(-,-,-,-)
%dir "/boot"
"/boot/config-3.14.38-6UL_ga+ge4944a5"
"/boot/Module.symvers-3.14.38-6UL_ga+ge4944a5"
"/boot/System.map-3.14.38-6UL_ga+ge4944a5"
...
%defattr(-,-,-,-)
%dir "/boot"
"/boot/devicetree-zImage-imx6ul-14x14-evk.dtb"
"/boot/devicetree-zImage-imx6ul-14x14-evk-csi.dtb"
...
%dir "/lib/modules"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/crypto"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/crypto/tcrypt.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/i2c"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/i2c/algos"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/i2c/algos/i2c-algo-pca.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/i2c"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/i2c/algos"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/i2c/algos/i2c-algo-pcf.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input/evbug.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input/mouse"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input/mouse/psmouse.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input/serio"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/input/serio/serport.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/adv7180_tvin.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ipu_bg_overlay_sdc.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ipu_csi_enc.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ipu_fg_overlay_sdc.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ipu_prp_enc.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ipu_still.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/mxc_v4l2_capture.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ov5640_camera_int.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ov5640_camera_mipi_int.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/ov5642_camera.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/capture/v4l2-int-device.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev/mx6s_capture.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev/mxc_mipi_csi.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev/mxc_vadc.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev/ov5640_camera.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/platform/mxc/subdev/ov5640_camera_mipi.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/usb/gspca"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/usb/gspca/gspca_main.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/usb/uvc"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/usb/uvc/uvcvideo.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/v4l2-core"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/media/v4l2-core/videobuf2-vmalloc.ko"

%files -n kernel-module-mxc-mlb
%defattr(-,-,-,-)
%dir "/lib"
%dir "/lib/modules"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/mxc"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/mxc/mlb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/mxc/mlb/mxc_mlb.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/asix.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/ax88179_178a.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/cdc_eem.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/cdc_ether.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/cdc_ncm.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/cdc_subset.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/net1080.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/pegasus.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/r8152.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/rtl8150.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/usbnet.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/usb/zaurus.ko"

%files -n kernel-module-ath6kl-core
%defattr(-,-,-,-)
%dir "/lib"
%dir "/lib/modules"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/ath"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/ath/ath6kl"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/ath/ath6kl/ath6kl_core.ko"

%files -n kernel-module-ath6kl-sdio
%defattr(-,-,-,-)
%dir "/lib"
%dir "/lib/modules"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/ath"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/ath/ath6kl"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/ath/ath6kl/ath6kl_sdio.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/bcmdhd"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/net/wireless/bcmdhd/bcmdhd.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/class"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/class/cdc-acm.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/g_ether.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/g_mass_storage.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/g_ncm.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/g_serial.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/g_zero.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/gadgetfs.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/libcomposite.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/u_ether.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/u_serial.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_acm.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_ecm.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_ecm_subset.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_eem.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_fs.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_mass_storage.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_ncm.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_obex.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_rndis.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_serial.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/gadget/usb_f_ss_lb.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial/ftdi_sio.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial/option.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial/usb_wwan.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/usb/serial/usbserial.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/video"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/video/mxc"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/drivers/video/mxc/mxc_dcic.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/binfmt_misc.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/configfs"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/configfs/configfs.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/fat"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/fat/msdos.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/isofs"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/isofs/isofs.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/nls"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/nls/nls_iso8859-15.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/udf"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/fs/udf/udf.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib/crc-ccitt.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib/crc-itu-t.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib/crc7.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/lib/libcrc32c.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/core"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/core/snd-hwdep.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/core"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/core/snd-rawmidi.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/usb/snd-usb-audio.ko"
...
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound"
%dir "/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/usb"
"/lib/modules/3.14.38-6UL_ga+ge4944a5/kernel/sound/usb/snd-usbmidi-lib.ko"
